  ...
  render() {
    ...
    return (
      <div className="movie-card">
        ...
        <CardFront poster={posterMap[this.props.content.poster]}/>
        <CardBack title={this.props.content.title} rating={this.props.content.IMDBRating} genres={this.props.content.genres.join(", ")}/>
      </div>
    )
  }
}
