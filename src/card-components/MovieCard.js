  ...
  render() {
    return (
      <div className="movie-card">
        ...
        <CardFront title={this.props.title} genres={this.props.genres} rating={this.props.rating} poster={posterMap[this.props.poster]}/>
        <CardBack title={this.props.title} genres={this.props.genres} IMDBRating={this.props.IMDBRating} poster={posterMap[this.props.poster]}/>
      </div>
    )
  }
}
